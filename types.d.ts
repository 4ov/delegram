 ...
 */
  ...
  */
  interface Chat {
    ...
    * must first generate the link using ChatInviteLink. Returned only 
    * in getChat.
  ...
  * Returns True on success.
  */
  interface DeleteStickerFromSet {
   /**
    * File identifier of the sticker
    */
   sticker: string;
